  ...
  const mockStrategies = [
    {
      ...
      description: 'Automatically compounds yields across multiple DeFi protocols for maximum returns.',
      creator: 'CryptoAlpha',
    ...
    },
    {
      ...
      description: 'Exploits price differences across exchanges for consistent, low-risk profits.',
      creator: 'QuantTrader',
      creatorAvatar: '/api/placeholder/40/40',
      category: 'Arbitrage',
      performance: '+89.1%',
    ...
    },
    {
      ...
      description: 'High-frequency trading strategy that captures small price movements.',
      creator: 'TechAnalyst',
      creatorAvatar: '/api/placeholder/40/40',
      category: 'Scalping',
      performance: '+156.7%',
    ...
    },
    {
      ...
      description: 'Places buy and sell orders at predetermined intervals to profit from volatility.',
      creator: 'GridMaster',
      creatorAvatar: '/api/placeholder/40/40',
    ...
    },
    {
      ...
      description: 'Identifies oversold/overbought conditions and trades accordingly.',
      creator: 'StatArb',
      creatorAvatar: '/api/placeholder/40/40',
    ...
    },
    {
      ...
      description: 'Automated NFT floor price buying strategy with rarity analysis.',
      creator: 'NFTGuru',
      creatorAvatar: '/api/placeholder/40/40',
      category: 'NFT',
      performance: '+203.1%',
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Strategy Marketplace</h1>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-between items-center text-sm">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-gray-600">({strategy.users} users)</span>
                  </div>
                  <div className="flex items-center space-x-1 text-gray-600">
                ...
                <div className="pt-4 border-t">
                  <div className="flex justify-between items-center mb-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{strategy.priceUSD}</p>
                    </div>
        ...
        {filteredStrategies.length === 0 && !loading && (
          <div className="text-center py-12">
            <Alert className="max-w-md mx-auto">
              <AlertDescription>
                No strategies found matching your filters. Try adjusting your search criteria.
              </AlertDescription>
            </Alert>
          </div>
        )}
