        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-2xl p-8 transform rotate-3 relative overflow-hidden">
                {/* Background Pattern */}
                ...
                <div className="space-y-6 relative z-10">
                  ...
                  <div className="relative h-32 bg-gradient-to-br from-green-50 to-blue-50 rounded-xl border border-green-100 overflow-hidden">
                    ...
                    {/* Floating Stats */}
                    <div className="absolute top-2 right-2 bg-white/90 backdrop-blur-sm rounded-lg px-2 py-1 shadow-sm border border-gray-100">
              ...
              >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold">{strategy.price}</span>
                  </div>
                  <div className="flex justify-between items-center">
